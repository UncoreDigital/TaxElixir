  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Brand tokens sampled from logo.jpeg */
        navy: {
      ...
      boxShadow: {
        soft: "0 2px 10px -2px hsl(213 71% 16% / 0.08)",
        card: "0 10px 30px -6px hsl(213 71% 16% / 0.10)",
        lift: "0 20px 50px -12px hsl(213 71% 16% / 0.18)",
        gold: "0 10px 30px -8px hsl(43 51% 58% / 0.45)",
      },
      keyframes: {
        "fade-in-up": {
